...
while True:
    ...
    for box in results.boxes:
        ...
        if model.names[cls_id] == "person": # model.names is a dict for ex. {id1: "person", id2: "biycycle", id3: "car"..}
            ...
            if conf > 0.55: #this is a threshold value if prob > 0.50 show it!
                ...
                detections.append(Detection(np.array([[cx, cy]]))) #append to the detections as the Norfair format
    ...
    for object in tracked_objects:
        ...
        cv2.putText(frame, f"ID: {track_id}", (x1, y2), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 117, 44), 2)
